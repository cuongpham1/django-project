...
from deliverynowapp import views, apis
...
urlpatterns = [
    ...
    url(r'^restaurant/order/notification/(?P<last_request_time>.+)/$', apis.restaurant_order_notification),
    ...
    url(r'^api/driver/location/$', apis.customer_driver_location),

    # APIs for driver
    url(r'^api/driver/orders/ready/$', apis.driver_get_ready_orders),
    url(r'^api/driver/orders/pick/$', apis.driver_pick_order),
    url(r'^api/driver/orders/lastest/$', apis.driver_get_lastest_order),
